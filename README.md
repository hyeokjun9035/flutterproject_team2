...
- 사고나 이슈가 발생시 반경 2km 이내 사용자에게 알림 전송
- km 선택하여 글쓴 장소 지도로 확인 가능
...
📆 <b>총 개발 기간 : 2025년 12월 22일 ~ 2026년 1월 8일(약3주 진행)</b>
...
<table>
  ...
  <tbody>
    <tr>
      <td>권혁준(팀장)</td>
      <td>
        <a href="https://github.com/hyeokjun9035">
          <img src="https://img.shields.io/badge/GitHub-권혁준-black?logo=github"/>
        </a>
      </td>
    </tr>
    <tr>
      <td>김성민</td>
      <td>
        <a href="https://github.com/Kimseongmin3790">
          <img src="https://img.shields.io/badge/GitHub-김성민-black?logo=github"/>
        </a>
      </td>
    </tr>
    <tr>
      <td>엄재준</td>
      <td>
        <a href="https://github.com/jjeom101">
          <img src="https://img.shields.io/badge/GitHub-엄재준-black?logo=github"/>
        </a>
      </td>
    </tr>
    <tr>
      <td>전경환</td>
      <td>
        <a href="https://github.com/gatsby6060">
          <img src="https://img.shields.io/badge/GitHub-전경환-black?logo=github"/>
        </a>
      </td>
    </tr>
    <tr>
...
<details>
  ...
  <p>
    메인 페이지에서는 “현재 날씨를 한눈에 확인 + 상황에 맞는 행동(이동/제보/커뮤니티)로 빠르게 연결”
    되는 흐름을 목표로 UI/기능을 구성했습니다.
  </p>
  ...
  <!-- 1) 날씨 기반 메인 비주얼 -->
  <!-- ===================== -->
  <h3>🌤️ 정확한 날씨/대기 정보 기반 메인 비주얼 + 오늘 챙길 것 추천</h3>
  <p>
    기상청 API(날씨)와 에어코리아 API(대기질)를 활용해 현재 상태를 반영하고,
    하늘 상태(맑음/구름/흐림)·강수(비/눈)·일출/일몰 기준 낮/밤 여부에 따라
    홈 배경이 자동으로 변하도록 구현했습니다. (전환은 애니메이션 처리)
    또한 오늘의 날씨/대기 상태를 기반으로 “오늘 챙길 것(준비물/행동)”을 간단히 추천해
    사용자가 한눈에 필요한 정보를 확인할 수 있도록 구성했습니다.
  </p>
  ...
  <ul>
    <li>기상청 API/에어코리아 API 기반 현재 날씨/대기 정보 표시</li>
    <li>날씨/낮밤 기반 동적 배경 테마(하늘 상태/강수 반영)</li>
    <li>날씨/대기질 기반 오늘 챙길 것(예: 우산/겉옷/마스크 등) 안내</li>
  </ul>
  ...
  <!-- 2) 대중교통/즐겨찾기 루트 -->
  <!-- ===================== -->
  <h3>🚌 즐겨찾기 루트 기반 이동 카드 (TMAP 대중교통 + 도보 폴백)</h3>
  <p>
    사용자가 저장한 즐겨찾기(출발/도착)를 기준으로 대중교통 경로를 불러와
    “최소 도보 / 최소 시간 / 최소 환승” 옵션을 요약해서 보여줍니다.
  ...
  <!-- 3) 실시간 버스 도착 -->
  <!-- ===================== -->
  <h3>⏱️ 실시간 버스 도착 정보 (지원 노선)</h3>
  <p>
    대중교통 경로에 버스 구간이 포함될 경우, 승차 정류장 기반으로
    실시간 도착 정보를 표시하도록 연동했습니다.
  ...
  <ul>
    ...
    <li>주기적 갱신(폴링) + 캐시로 불필요한 호출 최소화</li>
  </ul>

  <br/>

  <!-- ===================== -->
  <!-- 4) 주변 이슈/커뮤니티 연결 + 홈 UX -->
  <!-- ===================== -->
  <h3>📍 내 주변 1km 사건/이슈 + 홈 UX(편집/메뉴)</h3>
  <p>
    현재 위치 기준 1km 반경의 사건/이슈 글을 홈에서 최신 3건까지 미리 확인하고,
    지도 보기/제보/커뮤니티 등 주요 기능으로 빠르게 이동할 수 있도록 구성했습니다.
  ...
  <ul>
    ...
    <li>Drawer 메뉴(마이페이지/커뮤니티/제보/설정/로그아웃) 공통 적용</li>
    <li>홈 카드 순서 편집 기능(사용자 설정 유지)</li>
  </ul>
...
<details>
  ...
  <p align="center">
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_add11.png" style="height:500px; width:auto; max-width:30%;"/>
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/location11.png" style="height:500px; width:auto; max-width:30%;"/>
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_add_play.gif" style="height:500px; width:auto; max-width:30%;"/>
  </p>
  ...
  <h3>🔍 게시글 상세 보기 & 소통</h3>
  <p>
    게시글 상세 화면에서 사진·영상·본문·위치 정보를 함께 제공하고,
    댓글·대댓글·좋아요·신고 기능을 통해 사용자 간 활발한 소통이 이루어지도록 설계했습니다.
    탈퇴 회원의 게시글은 프로필을 미노출 처리해 커뮤니티 신뢰도를 유지합니다.
  </p>

  <p align="center">
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_view11.png" style="height:450px; width:auto; max-width:15%;"/>
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_view211.png" style="height:450px; width:auto; max-width:15%;"/>
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_report.png" style="height:450px; width:auto; max-width:15%;"/>
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_view_play.gif" style="height:450px; width:auto; max-width:15%;"/>
  </p>
  ...
  <h3>🛠 게시글 수정 & 관리</h3>
  <p>
    작성한 게시글은 언제든 수정·삭제할 수 있으며,
    이미지 교체, 위치 재설정 등 콘텐츠를 유연하게 관리할 수 있도록 구현했습니다.
  </p>

  <p align="center">
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_edit11.png" style="height:500px; width:auto; max-width:30%;"/>
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_edit211.png" style="height:500px; width:auto; max-width:30%;"/>
    <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/community/community_edit_play.gif"style="height:500px; width:auto; max-width:30%;"/>
  </p>
...
<details>
 ...
 <p align="center">
   ...
   <p align="center">
     ...
     <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/mypage/chatAliram.gif" width="230"/>
     <img src="https://github.com/hyeokjun9035/flutter_image/blob/main/mypage/likeAlram.gif" width="220"/>
 </p>
   <ul>
