...
<details>
  ...
  <!-- 1) 날씨 기반 메인 비주얼 -->
  <!-- ===================== -->
  <h3>🌤️ 날씨 기반 메인 비주얼 (낮/밤 + 하늘 + 강수)</h3>
  <p>
    현재 날씨 상태(맑음/구름/흐림)와 강수(비/눈), 그리고 일출/일몰 기준의 낮/밤 여부에 따라
    홈 배경이 자동으로 변하도록 구현했습니다. (전환은 자연스럽게 애니메이션 처리)
  </p>
  ...
  <ul>
    <li>날씨/낮밤 기반 동적 배경 테마</li>
    <li>비/눈 등 강수 시 시각적 레이어(효과) 적용</li>
  </ul>
