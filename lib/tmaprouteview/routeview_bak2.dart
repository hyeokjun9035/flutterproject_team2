  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          // ✅ 상단 요약 카드 (버스/지하철/도보 시간)
          _SummaryBar(summary: summary),

          // ✅ 디버그(원하면 지워도 됨)(데이터는 넘어오니까 지움)
          // Container(
          //   padding: const EdgeInsets.all(10),
          //   color: Colors.black12,
          //   child: Text(debugMsg, style: const TextStyle(fontSize: 12)),
          // ),
          ...
          // ✅ 하단: 구간 리스트 (환승 구간별로 텍스트)
          _LegList(segments: segments),
        ],
      ),
    );
  }
...
class _LegList extends StatelessWidget {
  ...
  const _LegList({required this.segments});
